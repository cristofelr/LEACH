...
Como disse o ns3 e um simulador de eventos discretos, ou seja, que alteram ao longo do tempo. Outrossim, e que ele usa conteineres. Para criar a rede, primeiro voce devera criar um NodeContainer com os sensores(nodes) e em seguida criar outro NetDeviceContainer que sera a rede onde colocara os sensores(nodes). A dinamica é essa, um conteiner dentro do outro. Agora basta se familiarizar com o ns3 e simular suas primeiras redes (https://www.nsnam.org/docs/tutorial-pt-br/html/conceptual-overview.html
